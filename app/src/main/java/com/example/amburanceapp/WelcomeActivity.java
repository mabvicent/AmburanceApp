...
public class WelcomeActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private com.google.android.gms.maps.model.PolylineOptions polylineOptions,blackPolylineOption;
    private Polyline polyline,blackPolyline,greyPolyline;
    private IGoogleAPI mService;
    // presence persistance
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentUserRef = FirebaseDatabase.getInstance().getReference(Common.doctor_tb1)
        ...
        place.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                if(loccation_switch.isChecked()){
                    ...
                    Toast.makeText(WelcomeActivity.this,"Please change your status online",Toast.LENGTH_SHORT).show();
                }
